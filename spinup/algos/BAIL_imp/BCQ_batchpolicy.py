...
class BCQ(object):
	...
	def train(self, replay_buffer, iterations, batch_size=100, discount=0.99, tau=0.005, logger=dict()):
		...
		bcq_state_dict = {'policy_net': self.actor.state_dict(), 'policy_target_net': self.actor_target.state_dict(),
						  'double_q_net': self.critic.state_dict(),  'double_q_target_net': self.critic_target.state_dict(),
						  'vae_net': self.vae.state_dict()}
		return bcq_state_dict
